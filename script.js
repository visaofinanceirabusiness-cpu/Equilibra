(function(){
  var translations = {
    pt: {
      ...
      "svc.terapeutica.t":"Massagem Descontraturante","svc.terapeutica.d":"Técnicas manuais focadas em aliviar dores específicas e devolver a mobilidade.",
    ...
    es: {
      ...
      "svc.terapeutica.t":"Masaje Descontracturante","svc.terapeutica.d":"Técnicas manuales enfocadas en aliviar dolores específicos y recuperar la movilidad.",
    ...
    en: {
      ...
      "svc.terapeutica.t":"Deep Tissue Massage","svc.terapeutica.d":"Hands-on techniques focused on relieving specific pain and restoring mobility.",
  ...
  function initPromoCarousel(){
    ...
    var slides = track.querySelectorAll(".promo__slide");
    var dots = carousel.querySelectorAll(".promo__dot");
    var prevBtn = carousel.querySelector(".promo__arrow--prev");
    var nextBtn = carousel.querySelector(".promo__arrow--next");
    var index = 0;
